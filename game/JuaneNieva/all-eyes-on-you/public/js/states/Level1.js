...
PoligonosDeLaMuerte.Level1.prototype ={
    create:function(game){
        ...
        var txt = game.add.text(this.game.width/2,this.game.height/2,'Press Q to switch weapon 🔫',{font:"26px Arial",fill:"#FF0000",align:"center"});
        this.initPauseMenu();
    ...
    update:function(game){
        ...
        if(this.game.playerAlive){
            ...
            var txt = game.add.text(this.game.width/2,this.game.height/2,'GAME OVER',{font:"72px Arial",fill:"#FF0000",align:"center"});
            txt.anchor.setTo(0.5);
            var txt2 = game.add.text((this.game.width/2),(this.game.height/2)+100,'SCORE: '+this.player.score ,{font:"72px Arial",fill:"#FF0000",align:"center"});
            txt2.anchor.setTo(0.5);
        }
  },
  render:function(game) {
        this.game.debug.text('Life: '+this.player.life, 32, 30  );
        this.game.debug.text('Alive Enemies: ' + this.enemies.countLiving(), 32, 45);
        this.game.debug.text('Created Enemies: ' + amountZombies +' of: '+MAX_ZOMBIES, 32,60);
        this.game.debug.text('Weapon: '+this.BULLET_TYPE[this.actualWeapon], 32, 75);
        if(this.BULLET_TYPE[this.actualWeapon]===this.BULLET_TYPE[0] || this.BULLET_TYPE[this.actualWeapon]===this.BULLET_TYPE[2] ){
            this.game.debug.text('Active Bullets: ' + this.bullets.countLiving() + ' / ' + this.bullets.total, 32, 90);
        }
    ...
    initBullets: function() {
        ...
        for(var i=0;i<50;i++){
          this.bullets.add(new PoligonosDeLaMuerte.Normal(this.game,999999,999999));
        }
    },
    initPlayer: function() {
