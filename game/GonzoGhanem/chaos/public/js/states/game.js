...
Chaos.Game = {
  ...
  create: function() {
    ...
    ////////////////
    this.basic_weapon_text = this.game.add.text(this.game.world.bounds.left + 10, this.game.world.bounds.top + 10, "Canon (Q)", this.getTextStyle(this.game_constants.weapons.selected_color));

    this.machine_gun_weapon_text = this.game.add.text(this.game.world.bounds.left + 200, this.game.world.bounds.top + 10, "Machine Gun (W)", this.getTextStyle(this.game_constants.weapons.unselected_color));

    this.bomb_weapon_text = this.game.add.text(this.game.world.bounds.left + 500, this.game.world.bounds.top + 10, "Bomb (E)", this.getTextStyle(this.game_constants.weapons.unavailable_color));
    ...
    this.player_score_text = this.game.add.text(this.game.world.bounds.left + 1000, this.game.world.bounds.top + 10, "Score: 0", this.getTextStyle(this.game_constants.weapons.unselected_color));
    
    this.player_life_text = this.game.add.text(this.game.world.bounds.left + 1200, this.game.world.bounds.top + 10, "Life: 100", this.getTextStyle(this.game_constants.weapons.unselected_color));

    this.pause_text = this.game.add.text(this.game.world.centerX - 100, this.game.world.centerY, 'PAUSE', {
      font: "40px Arial",
      boundsAlignH: "center",
      align: "center",
    ...
    this.bomb_ready_text = this.game.add.text(this.game.world.centerX - 100, this.game.world.centerY, 'BOMB AVAILABLE! (E)', {
      font: "40px Arial",
      boundsAlignH: "center",
      align: "center",
      fill: this.game_constants.weapons.unselected_color
